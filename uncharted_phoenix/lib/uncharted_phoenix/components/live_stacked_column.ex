defmodule UnchartedPhoenix.LiveStackedColumnComponent do
  @moduledoc """
  ...
  def update(assigns, socket) do
    ...
    socket =
      ...
      |> assign(:columns, Uncharted.StackedColumnChart.columns(assigns.chart))
  ...
  def render(assigns) do
    Phoenix.View.render(UnchartedPhoenix.ComponentView, "live_stacked_column.html", assigns)
  end
