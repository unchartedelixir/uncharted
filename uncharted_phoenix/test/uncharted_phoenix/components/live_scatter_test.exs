defmodule UnchartedPhoenix.LiveScatterComponentTest do
  ...
  describe "ScatterPlotComponent" do
    test "renders" do
      assert render_chart(@base_chart) =~ ~s(data-testid="lc-live-scatter-component")
    end
