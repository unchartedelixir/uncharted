defmodule UnchartedPhoenix.LiveFunnelComponentTest do
  alias Uncharted.{BaseChart, Section}
  alias Uncharted.Axes.{BaseAxes, MagnitudeAxis}
  alias Uncharted.FunnelChart.Dataset
  ...
  describe "LiveFunnelComponent" do
    test "renders" do
      assert render_chart(@base_chart) =~ ~s(data-testid="lc-live-funnel-component")
    end
