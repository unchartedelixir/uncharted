defmodule UnchartedPhoenix.LiveHorizontalFunnelComponentTest do
  alias Uncharted.{BaseChart, Section}
  alias Uncharted.Axes.{BaseAxes, MagnitudeAxis}
  alias Uncharted.HorizontalFunnelChart.Dataset
  ...
  describe "LiveHorizontalFunnelComponent" do
    test "renders" do
      assert render_chart(@base_chart) =~ ~s(data-testid="lc-live-horiz-funnel-component")
    end
